...
class LaneSwitchHandler:
    def __init__(self, **kwargs) -> None:
        ...
        self.left_flipper_id = kwargs.pop("left_flipper_id")
        self.right_flipper_id = kwargs.pop("right_flipper_id")
...
class LeftLauncher:
    ...
    def handle_state(self, gameState):
        ...
        if not is_launched and pause_start > 0 and time() * 1000 >= pause_start + self.launcher_pause_time:
            ...
            return [(COMM_SOLENOIDS2, build_component_message(self.launcher_id))]
